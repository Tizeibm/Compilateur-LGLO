...
POST_INCREM : IDENTI INCR DIEZE { } ;
POST_DECREM : IDENTI DECR DIEZE { } ;

PRE_INCREM : INCR IDENTI DIEZE ;
PRE_DECREM : DECR IDENTI DIEZE ;
...
ECRITURE : ECRIRE PAROUV IDENTI PARFERM DIEZE
...
BOUCLEPOUR : POUR PAROUV IDENTI FLECHE NOMBRE DIEZE IDENTI COND_SIMPLE  DIEZE PRE_INCREM PARFERM ACCOUV BLOC ACCFERM 
           | POUR PAROUV IDENTI FLECHE NOMBRE DIEZE IDENTI COND_SIMPLE  DIEZE POST_INCREM PARFERM ACCOUV BLOC ACCFERM
           | POUR PAROUV IDENTI FLECHE NOMBRE DIEZE IDENTI COND_SIMPLE  DIEZE PRE_DECREM PARFERM ACCOUV BLOC ACCFERM
           | POUR PAROUV IDENTI FLECHE NOMBRE DIEZE IDENTI COND_SIMPLE  DIEZE POST_DECREM PARFERM ACCOUV BLOC ACCFERM   
           ;
